    ...
    <section className="px-8 relative py-16 bg-gray-900 overflow-hidden">
      <div className="flex flex-wrap">
        <div className="w-full md:w-1/2 lg:w-5/12">
          ...
          <div className="mt-8 flex flex-col justify-between h-full max-w-sm">
            <div>
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="flex flex-wrap items-center -ml-5">
              <div className="w-auto p-5">
                <Link href="https://twitter.com/scottXchoo" target="_blank">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 14 12"
              ...
              <div className="w-auto p-5">
                <Link
                  href="https://github.com/scottXchoo/Galaxy"
                  target="_blank"
                >
                  <svg
                    aria-hidden="true"
              ...
              <div className="w-auto p-5">
                <Link
                  href="https://www.instagram.com/dev.chooble/"
                  target="_blank"
                >
                  <svg
                    width="24"
